...
class TemporalPairDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return det, hist, long_hist, short_len, long_len, label, group_id, track_id
...
def parse_args():
    ...
    parser.add_argument("--ranking_margin", type=float, default=0.2, help="Required logit margin between positive and hard negative pairs from the same detection.")
    parser.add_argument("--hard_negative_topk", type=int, default=1, help="Number of hardest negatives per same-detection group used by ranking loss.")
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        for det, hist, long_hist, short_len, long_len, label, group_id, _track_id in train_loader:
